...
- Detect early warning signals in **sales and customer retention**
...
| Tool | Purpose |
|------|----------|
| **Microsoft Power BI** | Data extraction, transformation, visualization, and dashboard design |
| **Power Query** | Data cleaning and preparation |
| **DAX (Data Analysis Expressions)** | KPI computation and time-intelligence modeling |
| **Power BI Dashboards** | Interactive insight presentation for decision-makers |
...
- Identify **fading markets or customer segments**
- Recognize **seasonal opportunities** and optimize inventory
- Strengthen **customer loyalty and profitability**

By making decisions guided by these insights, leaders can **sustain growth**, **reduce operational risk**, and **capture untapped market potential**.
...
|------------------|-----------------|
| **Overall Performance** | Generated **$55M revenue**, **$23M cost**, and **$32M profit** (58.6% margin) with **198K units sold**. |
| **Growth Momentum** | 2018 recorded a **70%+ YOY growth** across all key metrics. |
| **Pandemic Impact** | 2020–2021 experienced a **49% revenue** and **89% profit decline**. |
| **Regional Breakdown** | **U.S.** market leads with **$29.8M revenue**, outperforming Canada by 380%. |
| **Product Performance** | **Computers** drive the highest profit; **Games & Toys** underperform significantly. |
| **High-Margin Category** | **Music, Movies & Audio** deliver a **61% profit margin** — most efficient segment. |
| **Seasonal Sales Peaks** | Strongest months: **January, February, and December**. |
| **Customer Behavior** | Top spender: *Matthew Flemming ($61,872)*. |
| **Customer Retention Risk** | 2021 saw **–92.9% new customers** and **–85.6% returning customers**. |
...
|----------------|----------------|----------------------|
| **Customer Retention** | Launch loyalty programs, personalized discounts, and automated re-engagement emails. | Increases repeat purchases and stabilizes revenue flow. |
...
- **Customer churn** could erode long-term profitability.  
- **Over-dependence on U.S. sales** may expose the company to regional shocks.  
...
- Improve **revenue predictability and margin stability**
- Enable **strategic expansion** and **resilience across markets**
- Empower leaders to make **data-backed, confident decisions**
...
Let’s connect or collaborate on **Business Intelligence, Data Analytics, or Power BI projects** 👇  
...
⭐ *Transforming Retail Data into Profitable Decisions — Because Insight Drives Growth.*
